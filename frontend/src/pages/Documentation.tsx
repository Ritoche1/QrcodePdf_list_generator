      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <Card>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-semibold text-gray-900">1) Projects</h3>
            </div>
          ...
          <Card>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-semibold text-gray-900">2) Entries and QR Content Types</h3>
            </div>
        ...
        <Card>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-base font-semibold text-gray-900">3) CSV Import Guide</h3>
          </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <Card>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-base font-semibold text-gray-900">4) Generate PDF</h3>
            </div>
